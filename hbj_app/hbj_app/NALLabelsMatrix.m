...
- (void)addRecord: (NSArray*)record {
    ...
    for(uint i=0; i<record.count; i++){
        ...
        [col1.layer setBorderColor:[[UIColor colorWithRed:245.0/255 green:245.0/255 blue:244.0/255 alpha:1] CGColor]];
        [col1.layer setBorderWidth:1.0];
        col1.font = [UIFont fontWithName:@"Helvetica" size:11.0];
        col1.frame = rect;
        ...
        if(self->numRows == 0){
            ...
            col1.backgroundColor = [UIColor colorWithWhite:0.961 alpha:0.8];
        }
